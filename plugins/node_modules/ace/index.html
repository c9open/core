...
<html>
    ...
    <body>
        <a href="https://github.com/ajaxorgopen/ace">
...
console.log(addResult);
                            ...
                            <p>Ace is a community project. We actively encourage and support
                                contributions! The Ace source code is <a href="https://github.com/ajaxorgopen/ace">hosted on GitHub</a>
                            ...
                            <pre>git clone git://github.com/ajaxorgopen/ace.git</pre>
                            <h2>History</h2>
                        ...
                        <div class="tab-pane fade active in" id="embedding">
                            ...
                            <a href="https://github.com/ajaxorgopen/ace-builds/">ace-builds</a> repository and use the code below:</p>
...
&lt;/html></pre>
                            ...
                            <p>If you want to clone and host Ace locally you can
                                use one of the <a href="https://github.com/ajaxorgopen/ace-builds/">pre-packaged versions</a>. Just copy
                                one of <code>src*</code> subdirectories somewhere into your project, or use RequireJS to load the
                                contents of <a href="https://github.com/ajaxorgopen/ace/tree/master/lib/ace">lib/ace</a> folder as <code>ace</code>:
                            </p>
...
editor.getOption("optionName");
                            ...
                            <p>See <a href="https://github.com/ajaxorgopen/ace/wiki/Configuring-Ace">Configuring-Ace wiki page</a> for a more detailed list of options.</p>
                            ...
                            <p><span class="expand_arrow">&gt;</span> <a href="https://github.com/ajaxorgopen/ace/tree/master/lib/ace/theme" target="_blank" rel="noreferer noopener">See all themes</a></p>
...
editor.findPrevious();</code></pre>
                            ...
                            <ul>
                                ...
                                <li>
                                    <code>range</code>: The <a class="internal absent" href="/ajaxorgopen/ace/wiki/Range">Range</a> to search within. Set this to <code>null</code> for the whole document
                                </li>
                                <li>
                                    <code>regExp</code>: Whether the search is a regular expression or not. Defaults to <code>false</code>.
                                </li>
                                <li>
                                    <code>start</code>: The starting <a class="internal absent" href="/ajaxorgopen/ace/wiki/Range">Range</a> or cursor position to begin the search
                                </li>
                                <li>
...
exports.MyNewHighlightRules = MyNewHighlightRules;
                            ...
                            <p>The Ace highlighting system is heavily inspired by the <a href="http://manual.macromates.com/en/language_grammars">TextMate language grammar</a>. Most tokens will follow the conventions of TextMate when naming grammars. A thorough (albeit incomplete) list of tokens can be found <a href="https://github.com/ajaxorgopen/ace/wiki/Creating-or-Extending-an-Edit-Mode#wiki-commonTokens">on the Ace Wiki</a>.</p>
                            <p>For the complete list of tokens, see <em><a href="https://github.com/ajaxorgopen/ace/blob/master/tool/tmtheme.js">tool/tmtheme.js</a></em>. It is possible to add new token names, but the scope of that knowledge is outside of this document.</p>
...

{
    ...
    "cdata" : [ {
        ...
        defaultToken : "text"
                            ...
                            <ol>
                                <li>In the Ace repository, navigate to the <em><a href="https://github.com/ajaxorgopen/ace/tree/master/tool">tools</a></em> folder.</li>
...
if (match) {
  ...
  endColumn: 13
                            ...
                            <ol>
                                <li>
                                    add an entry to <code>supportedModes</code> in <a href="https://github.com/ajaxorgopen/ace/blob/master/lib/ace/ext/modelist.js#L53"><code>ace/ext/modelist.js</code></a>
                                </li>
                                <li>
                        ...
                        <div class="tab-pane fade" id="production">
                            ...
                            <ul class="menu-list" style="overflow: hidden;">
                                ...
                                <li>
                                    ...
                                    <a href="https://github.com/ajaxorgopen/cloud9">Cloud9 IDE</a>
                                </li>
