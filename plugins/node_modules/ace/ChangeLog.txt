...
* API Changes
  - unified delta types `{start, end, action, lines}`  (Alden Daniels https://github.com/ajaxorgopen/ace/pull/1745)
...
* Extensive support for Cocoa style keybindings on the Mac <https://github.com/ajaxorgopen/ace/issues/closed#issue/116/comment/767803>
* New commands:
...
* Unit tests can also be run in the browser
  <https://github.com/ajaxorgopen/ace/blob/master/lib/ace/test/tests.html>
